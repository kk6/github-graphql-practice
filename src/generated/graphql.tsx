...
export type MostStaredRepositoriesQueryVariables = Exact<{
  searchQuery: Scalars['String'];
  count?: Maybe<Scalars['Int']>;
}>;


export type MostStaredRepositoriesQuery = { __typename?: 'Query', search: { __typename?: 'SearchResultItemConnection', repositoryCount: number, edges?: Maybe<Array<Maybe<{ __typename?: 'SearchResultItemEdge', node?: Maybe<{ __typename?: 'App' } | { __typename?: 'Discussion' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | { __typename?: 'Repository', id: string, name: string, description?: Maybe<string>, stargazerCount: number, url: any, owner: { __typename?: 'Organization', login: string } | { __typename?: 'User', login: string } } | { __typename?: 'User' }> }>>> } };


export const MostStaredRepositoriesDocument = gql`
...
/**
 * __useMostStaredRepositoriesQuery__
 *
 * To run a query within a React component, call `useMostStaredRepositoriesQuery` and pass it any options that fit your needs.
 * When your component renders, `useMostStaredRepositoriesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMostStaredRepositoriesQuery({
 *   variables: {
 ...
 * });
 */
export function useMostStaredRepositoriesQuery(baseOptions: Apollo.QueryHookOptions<MostStaredRepositoriesQuery, MostStaredRepositoriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MostStaredRepositoriesQuery, MostStaredRepositoriesQueryVariables>(MostStaredRepositoriesDocument, options);
      }
export function useMostStaredRepositoriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MostStaredRepositoriesQuery, MostStaredRepositoriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MostStaredRepositoriesQuery, MostStaredRepositoriesQueryVariables>(MostStaredRepositoriesDocument, options);
        }
export type MostStaredRepositoriesQueryHookResult = ReturnType<typeof useMostStaredRepositoriesQuery>;
export type MostStaredRepositoriesLazyQueryHookResult = ReturnType<typeof useMostStaredRepositoriesLazyQuery>;
export type MostStaredRepositoriesQueryResult = Apollo.QueryResult<MostStaredRepositoriesQuery, MostStaredRepositoriesQueryVariables>;